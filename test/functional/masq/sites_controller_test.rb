...
module Masq
  class SitesControllerTest < ActionController::TestCase
    ...
    def test_should_require_login_for_edit
      get :edit, params: {:id => sites(:venteria).id}
      assert_login_required
    end
    ...
    def test_should_require_login_for_update
      put :update, params: {:id => sites(:venteria).id, :site => valid_site_attributes}
      assert_login_required
    end
    ...
    def test_should_update_site
      login_as(:standard)
      @site = sites(:venteria)
      put :update, params: {:id => @site.id, :site => valid_site_attributes}
