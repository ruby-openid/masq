module Masq
  class ServerController < BaseController
    ...
    before_filter :login_required, except: %i[index cancel seatbelt_config seatbelt_login_state]
    before_filter :ensure_valid_checkid_request, except: %i[index cancel seatbelt_config seatbelt_login_state]
    after_filter :clear_checkid_request, only: %i[cancel complete]
